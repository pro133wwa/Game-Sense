...
public class GLSLSandbox implements Helper {
    private final int programId;
    private final int timeUniform;
    private final int mouseUniform;
    private final int resolutionUniform;

    public GLSLSandbox(String fragment) throws IOException {
        this("gui/passthrough.vsh", fragment);
    }

    public GLSLSandbox(String vert, String fragment) throws IOException {
        int program = glCreateProgram();

        glAttachShader(program,
                createShader(GLSLSandbox.class.getResourceAsStream("/assets/minecraft/heaven/shaders/" + vert),
                        GL_VERTEX_SHADER));
        glAttachShader(program,
                createShader(
                        GLSLSandbox.class.getResourceAsStream("/assets/minecraft/heaven/shaders/" + fragment),
                        GL_FRAGMENT_SHADER));
