...
public class EntityESP
    ...
    public EntityESP() {
        super("EntityESP", "Показывает игроков, ник и их здоровье сквозь стены", ModuleCategory.RENDER);
    ...
    public void onRender2D(EventRender2D event) {
        ...
        for (Entity entity : mc.world.loadedEntityList) {
            ...
            if (GameSense.instance.friendManager.isFriend(entity.getName()) && friendHighlight.getBoolValue()) {
            ...
            double height = (double) entity.height + (entity.isSneaking() || entity == EntityESP.mc.player && EntityESP.mc.player.isSneaking() ? -0.3 : !(!GameSense.instance.featureManager.getFeature(CustomModel.class).isEnabled() || CustomModel.onlyMe.getBoolValue() && entity != EntityESP.mc.player || !CustomModel.modelMode.currentMode.equals("Crab") && !CustomModel.modelMode.currentMode.equals("Amogus") && !CustomModel.modelMode.currentMode.equals("Chinchilla") && !CustomModel.modelMode.currentMode.equals("Red Panda")) ? -0.5 : 0.2);
            ...
            if (hpDetails.getBoolValue() && !espMode.currentMode.equals("Box")) {
                ...
                drawScaledString(healthDisplay, posX - 6.0 - (double) ((float) mc.neverlose900_18.getStringWidth(healthDisplay) * 0.5f), endPosY - hpHeight2, 0.5, colorHeal);
            }
