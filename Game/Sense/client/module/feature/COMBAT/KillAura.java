...
public class KillAura extends Module {
    ...
    public static ListSetting rotationMode = new ListSetting("Rotation Mode", "Matrix", () -> true, "Matrix", "Sunrise");
    ...
    public static BooleanSetting onlyCritical = new BooleanSetting("Only Critical", "Бьет в нужный момент для крита", true, () -> true);
    ...
    public BooleanSetting shieldFixer = new BooleanSetting("ShieldFixer", "Отжимает щит во время удара, помогает обойти Matrix", true, () -> true);
    ...
    public BooleanSetting shieldDesync = new BooleanSetting("Shield Desync", true, () -> true);
    public static BooleanSetting shieldBreaker = new BooleanSetting("ShieldBreaker", "Автоматически ломает щит противнику", true, () -> true);
    ...
    public KillAura() {
        ...
        addSettings(rotationMode, targetsSetting, range, walls, onlyCritical, shieldBreaker, shieldFixer, shieldDesync);
    }
    ...
    public void onRotations(EventPreMotion event) {
        ...
        if (!target.isDead) {
            ...
            if (mode.equalsIgnoreCase("Matrix")) {
                ...
                this.yaw2 = GCDFix.getFixedRotation(MathHelper.Rotate(this.yaw2, matrix[0], 600.0F, 600.0F));
    ...
    public void onUpdate(EventUpdate event) {
        /* SHIELD Desync */
        if (shieldDesync.getSettings().contains("Shield Desync") && target.getActiveItemStack().getItem() instanceof ItemShield && timerHelper.hasReached(Game.Sense.client.Helper.Utility.math.MathematicHelper.getRandomInRange(100, 400))) {
