...
import Game.Sense.client.module.feature.RENDER.anim.ClientSettings;
...
public class PenisESP extends Module {
    ...
    public static NumberSetting dlina = new NumberSetting("length of you", 4,0,10,0.001F, self::getBoolValue);
    public static NumberSetting dlinao = new NumberSetting("length of others", 0.2F,0,10,0.001F, others::getBoolValue);
    public PenisESP() {
        super("PenisESP","Ты действительно думаешь что это нужная функция?", ModuleCategory.RENDER);
    ...
    public void esp(EntityPlayer player, double x, double y, double z) {
        ...
        if (player == Minecraft.player && self.getBoolValue()) {
