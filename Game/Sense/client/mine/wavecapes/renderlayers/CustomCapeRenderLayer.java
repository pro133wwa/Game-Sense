package Game.Sense.client.mine.wavecapes.renderlayers;
...
import Game.Sense.client.mine.wavecapes.util.Mth;
...
public class CustomCapeRenderLayer implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer abstractClientPlayer, float paramFloat1, float paramFloat2, float deltaTick,
        ...
        if (GameSense.instance.featureManager.getFeature((CustomModel.class)).isEnabled()) {
            return;
        }
...
//        }
        this.playerRenderer.bindTexture(new ResourceLocation("GameSense/yfas.png"));
