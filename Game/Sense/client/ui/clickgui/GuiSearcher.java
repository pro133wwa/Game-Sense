        ...
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.drawShadow(5, 1, () -> {
                    ...
                    RoundedUtil.drawGradientRound(this.xPosition, this.yPosition, this.width, this.height,8,onecolor,onecolor,twocolor,twocolor);
                });
                Color onecolor = new Color(ClickGUI.bgonecolor.getColorValue());
                Color twocolor = new Color(ClickGUI.bgtwocolor.getColorValue());
                RoundedUtil.drawGradientRound(this.xPosition, this.yPosition,  this.width,  this.height,8,onecolor,onecolor,twocolor,twocolor);
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int) Minecraft.getMinecraft().neverlose900_18.drawStringWithShadow(s1, l, i1, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                j1 = (int) Minecraft.getMinecraft().neverlose900_18.drawStringWithShadow(s.substring(j), j1, i1, i);
            }
            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + Minecraft.getMinecraft().neverlose900_18.getFontHeight(), -3092272);
                } else {
                    Minecraft.getMinecraft().neverlose900_18.drawStringWithShadow("_", k1, i1, i);
                }
            }
            if (k != j) {
                int l1 = l + Minecraft.getMinecraft().neverlose900_18.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Minecraft.getMinecraft().neverlose900_18.getFontHeight());
            }
        }
    }
