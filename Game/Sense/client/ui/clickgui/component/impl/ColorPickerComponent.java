...
public class ColorPickerComponent extends ExpandableComponent implements PropertyComponent {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        mc.neverlose900_16.drawStringWithShadow(getName(), x + 2, y + height / 2F - 3, textColor);
        ...
        if (isExpanded()) {
            // Draw Background
            Gui.drawRect(x + Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET, y + height, x + width - Panel.X_ITEM_OFFSET, y + getHeightWithExpand(), new Color(20, 20, 20, 160).getRGB());
