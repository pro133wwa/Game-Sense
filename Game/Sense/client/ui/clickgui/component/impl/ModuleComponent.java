...
import Game.Sense.client.ui.clickgui.Panel;
...
import Game.Sense.client.ui.components.SorterHelper;
...
public final class ModuleComponent extends ExpandableComponent {
    ...
    public ModuleComponent(Game.Sense.client.ui.clickgui.component.Component parent, Feature module, int x, int y, int width, int height) {
        super(parent, module.getLabel(), x, y, width, height);
        this.module = module;
        int propertyX = Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET;
        for (Setting setting : module.getSettings()) {
            if (setting instanceof BooleanSetting) {
                components.add(new BooleanSettingComponent(this, (BooleanSetting) setting, propertyX, height, width - (Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET * 2), Game.Sense.client.ui.clickgui.Panel.ITEM_HEIGHT + 6));
            } else if (setting instanceof ColorSetting) {
                components.add(new ColorPickerComponent(this, (ColorSetting) setting, propertyX, height, width - (Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET * 2), Game.Sense.client.ui.clickgui.Panel.ITEM_HEIGHT));
            } else if (setting instanceof NumberSetting) {
                components.add(new NumberSettingComponent(this, (NumberSetting) setting, propertyX, height, width - (Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET * 2), Game.Sense.client.ui.clickgui.Panel.ITEM_HEIGHT + 5));
            } else if (setting instanceof ListSetting) {
                components.add(new ListSettingComponent(this, (ListSetting) setting, propertyX, height, width - (Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET * 2), Game.Sense.client.ui.clickgui.Panel.ITEM_HEIGHT + 2));
            } else if (setting instanceof MultipleBoolSetting) {
                components.add(new MultipleBoolSettingComponent(this, (MultipleBoolSetting) setting, propertyX, height, width - (Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET * 2), Game.Sense.client.ui.clickgui.Panel.ITEM_HEIGHT + 1));
            }
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        if (isExpanded()) {
            ...
            for (Game.Sense.client.ui.clickgui.component.Component child : components) {
