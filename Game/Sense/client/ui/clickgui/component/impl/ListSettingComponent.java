...
public class ListSettingComponent extends ExpandableComponent implements PropertyComponent {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        mc.neverlose900_14.drawStringWithOutline(getName(), x + 2 + Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET, dropDownBoxY + 3, new Color(222, 222, 222).getRGB());
    ...
    private void handleRender(int x, int y, int width, int textColor) {
        ...
        for (String e : listSetting.getModes()) {
            if (listSetting.currentMode.equals(e)) {
                mc.neverlose900_15.drawCenteredBlurredString(e, x + Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET + width / 2 + 0.5f, y + 2.5F, 8, RenderUtils.injectAlpha(new Color(ClickGUI.color.getColorValue()), 60), ClickGUI.color.getColorValue());
            } else {
                mc.neverlose900_15.drawCenteredString(e, x + Game.Sense.client.ui.clickgui.Panel.X_ITEM_OFFSET + width / 2 + 0.5f, y + 2.5F, Color.GRAY.getRGB());
