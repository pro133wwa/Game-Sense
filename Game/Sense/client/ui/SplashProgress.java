...
public class SplashProgress implements Helper {
    ...
    public static ResourceLocation resourceLocation = new ResourceLocation("GameSense/launch.png");
    ...
    private static void drawProgress() {
        ...
        float color = new Color(64, 26, 201, 0).getRGB();
        GlStateManager.resetColor();
        GlStateManager.TextureState.textureName = -1;
        pix.drawCenteredStringWithOutline("", sr.getScaledWidth() / 2, sr.getScaledHeight() / 2.5f, -1);
        pix1.drawBlurredString(String.format("") + "", 86 + calc - pix1.getStringWidth(String.format("") + ""), sr.getScaledHeight() - 87, 8, new Color(255, 255, 255, 50), -1);
