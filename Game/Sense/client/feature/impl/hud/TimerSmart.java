...
import Game.Sense.client.ui.newalt.PaletteHelper;
...
import static Game.Sense.client.feature.impl.movement.Timer.smart;

public class TimerSmart extends Feature {
    ...
    public TimerSmart(){
        super("TimerSmart", FeatureCategory.Hud);
