...
import Game.Sense.client.utils.math.KillauraUtils;
...
public class KillAura extends Feature {
    ...
    public void onUpdate(EventUpdate event) {
        /* SHIELD Desync */
        if (shieldDesync.getSettings().contains("Shield Desync") && target.getActiveItemStack().getItem() instanceof ItemShield && timerHelper.hasReached(Game.Sense.client.utils.math.MathematicHelper.getRandomInRange(100, 400))) {
