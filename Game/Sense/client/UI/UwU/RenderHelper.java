...
import Game.Sense.client.module.feature.RENDER.Tracers;
...
public class RenderHelper
    ...
    public static void tracersEsp(Entity entity, float lineWidth, float partialTicks, int color) {
        if (!GameSense.instance.friendManager.isFriend(entity.getName()) && GameSense.instance.featureManager.getFeature(Tracers.class).isEnabled()) {
            return;
        }
        ...
        if (GameSense.instance.friendManager.isFriend(entity.getName())) {
            float alpha = (float)(color >> 24 & 0xFF) / 255.0f;
        ...
        GL11.glBegin(2);
        GL11.glVertex3d(vec3d2.xCoord, (double)RenderHelper.mc.player.getEyeHeight() + vec3d2.yCoord, vec3d2.zCoord);
