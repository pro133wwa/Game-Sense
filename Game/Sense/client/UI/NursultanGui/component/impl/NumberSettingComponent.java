...
public class NumberSettingComponent extends Game.Sense.client.UI.NursultanGui.component.Component implements PropertyComponent {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        if (hovered) {
            if (numberSetting.getDesc() != null) {
                RenderUtils.drawSmoothRect(x + width + 20, y + height / 1.5F + 4.5F, x + width + 25 + mc.neverlose900_18.getStringWidth(numberSetting.getDesc()), y + 5.5F, new Color(0, 0, 0, 90).getRGB());
                mc.neverlose900_18.drawStringWithShadow(numberSetting.getDesc(), x + width + 22, y + height / 1.35F - 5F, -1);
            }
        }
    }
