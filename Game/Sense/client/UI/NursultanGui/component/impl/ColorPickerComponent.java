...
public class ColorPickerComponent extends ExpandableComponent implements PropertyComponent {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        if (isExpanded()) {
            // Draw Background
            Gui.drawRect(x + Game.Sense.client.UI.NursultanGui.Panel.X_ITEM_OFFSET, y + height, x + width - Panel.X_ITEM_OFFSET, y + getHeightWithExpand(), new Color(20, 20, 20, 160).getRGB());
