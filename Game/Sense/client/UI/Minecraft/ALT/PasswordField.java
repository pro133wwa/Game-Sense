package Game.Sense.client.UI.Minecraft.ALT;
...
public class PasswordField extends Gui {
   ...
   public void writeText(String par1Str) {
      ...
      if (this.text.length() > 0) {
         var10000 = String.valueOf(var2);
         var2 = var10000 + this.text.substring(0, var4);
      }

      int var8;
      if (var6 < var3.length()) {
         var10000 = String.valueOf(var2);
         var2 = var10000 + var3.substring(0, var6);
         var8 = var6;
      } else {
         var10000 = String.valueOf(var2);
         var2 = var10000 + var3;
      ...
      if (this.text.length() > 0 && var5 < this.text.length()) {
         var10000 = String.valueOf(var2);
         var2 = var10000 + this.text.substring(var5);
      }
      ...
      if (this.text.length() != 0) {
         if (this.selectionEnd != this.cursorPosition) {
            ...
            if (var4 < this.text.length()) {
               ...
               var5 = var10000 + this.text.substring(var4);
            }
   ...
   public void drawTextBox() {
      if (this.func_73778_q()) {
         if (this.getEnableBackgroundDrawing()) {
            //RenderUtils.drawRoundedRect((double)this.xPos - 1.5, (double)this.yPos - 1.5, (double)(this.xPos + this.width), (double)(this.yPos + this.height) + 1.5, 0, GameSense.getClientColor());
            //RenderUtils.drawRoundedRect((double)(this.xPos - 1), (double)(this.yPos - 1), (double)(this.xPos + this.width) - 0.5, (double)(this.yPos + this.height + 1), 0,(new Color(15, 15, 15, 255)));
         }
         ...
         if (var4.length() > 0) {
            ...
            var9 = Minecraft.fontRendererObj.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), (double)var7, (double)var8, var1);
         }
         ...
         if (var4.length() > 0 && var5 && var2 < var4.length()) {
            Minecraft.getMinecraft();
            Minecraft.fontRendererObj.drawStringWithShadow(var4.substring(var2), (double)var9, (double)var8, var1);
         }

         if (var6) {
            if (var10) {
               Gui.drawRect((double)var11, (double)(var8 - 1), (double)(var11 + 1), (double)(var8 + 1 + Helper.mc.neverlose900_20.getHeight()), -3092272);
            } else {
               Minecraft.getMinecraft();
               Minecraft.fontRendererObj.drawStringWithShadow("_", (double)var11, (double)var8, var1);
            }
         }

         if (var3 != var2) {
            int var12 = var7 + this.fontRenderer.getStringWidth(var4.substring(0, var3));
            this.drawCursorVertical(var11, var8 - 1, var12 - 1, var8 + 1 + Helper.mc.neverlose900_20.getHeight());
         }
      }
