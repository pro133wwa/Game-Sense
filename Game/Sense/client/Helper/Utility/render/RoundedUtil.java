...
public class RoundedUtil {
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("roundedRect");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("roundedRectGradient");
