package Game.Sense.client.Helper.Utility.render.cosmetic;

import Game.Sense.client.GameSense;
import Game.Sense.client.module.feature.RENDER.Cosmetics;
...
public class CosmeticRender implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (!GameSense.instance.featureManager.getFeature(Cosmetics.class).isEnabled())
            return;
