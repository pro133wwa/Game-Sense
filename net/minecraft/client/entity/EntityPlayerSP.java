...
import Game.Sense.client.event.events.impl.player.*;
...
import Game.Sense.client.feature.impl.player.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        ...
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                if (!GameSense.instance.featureManager.getFeature(FreeCam.class).isEnabled()) {
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        if (GameSense.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getBoolValue() || GameSense.instance.featureManager.getFeature(FreeCam.class).isEnabled() || GameSense.instance.featureManager.getFeature(NoClip.class).isEnabled())
            return false;
    ...
    public void onCriticalHit(Entity entityHit) {
        if(!GameSense.instance.featureManager.getFeature(DamageParticles.class).isEnabled()) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            this.movementInput.moveStrafe *= GameSense.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
            this.movementInput.moveForward *= GameSense.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
