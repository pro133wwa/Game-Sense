...
public class ItemRenderer {
    ...
    private void transformEatFirstPerson(float p_187454_1_, EnumHandSide p_187454_2_, ItemStack p_187454_3_) {
        ...
        if (GameSense.instance.featureManager.getFeature(ViewModel.class).isEnabled()) {
    ...
    private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
        ...
        if (GameSense.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && SwingAnimations.item360.getBoolValue()) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if (GameSense.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && !SwingAnimations.auraOnly.getBoolValue() || GameSense.instance.featureManager.getFeature(KillAura.class).isEnabled() && KillAura.target != null) {
                        if (GameSense.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && !SwingAnimations.auraOnly.getBoolValue() || GameSense.instance.featureManager.getFeature(KillAura.class).isEnabled() && KillAura.target != null) {
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (!GameSense.instance.featureManager.getFeature(NoOverlay.class).isEnabled() && !NoOverlay.noFire.getBoolValue()) {
