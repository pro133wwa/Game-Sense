...
import Game.Sense.client.feature.impl.visual.FogColor;
import Game.Sense.client.feature.impl.visual.WorldFeatures;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.world != null) {
            ...
            for (int j = 0; j < list.size(); ++j) {
                ...
                if (entity1 instanceof EntityArmorStand && GameSense.instance.featureManager.getFeature(NoInteract.class).isEnabled() && NoInteract.armorStands.getBoolValue()) {
                    return;
                }
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (GameSense.instance.featureManager.getFeature(NoOverlay.class).isEnabled() && NoOverlay.noHurtCam.getBoolValue()) {
            return;
        }
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    if (raytraceresult != null) {
                        ...
                        if (GameSense.instance.featureManager.getFeature(NoOverlay.class).isEnabled() && NoOverlay.cameraClip.getBoolValue()) {
    ...
    private void updateLightmap(float partialTicks) {
        if (this.lightmapUpdateNeeded) {
            ...
            if (world != null) {
                ...
                if (GameSense.instance.featureManager.getFeature(WorldFeatures.class).isEnabled() && WorldFeatures.worldColor.getBoolValue()) {
    ...
    protected void renderRainSnow(float partialTicks) {
        ...
        if (GameSense.instance.featureManager.getFeature(WorldFeatures.class).isEnabled() && WorldFeatures.snow.getBoolValue()) {
            ...
            if (f > 0.0F) {
                ...
                for (int k1 = k - i1; k1 <= k + i1; k1++) {
                    for (int l1 = i - i1; l1 <= i + i1; l1++) {
                        ...
                        boolean check = GameSense.instance.featureManager.getFeature(WorldFeatures.class).isEnabled() && WorldFeatures.snow.getBoolValue() ? true : ((biome.canRain() || biome.getEnableSnow()));
                        if (check) {
    ...
    private void setupFog(int startCoords, float partialTicks) {
        ...
        if (f >= 0.0F) {
            ...
            if (startCoords == -1) {
                ...
                float dist = GameSense.instance.featureManager.getFeature(FogColor.class).isEnabled() ? -FogColor.distance.getNumberValue() : Config.getFogStart();
    ...
    public void func_190565_a(ItemStack p_190565_1_) {
        if (GameSense.instance.featureManager.getFeature(NoOverlay.class).isEnabled() && NoOverlay.antiTotem.getBoolValue()) {
            return;
        }
