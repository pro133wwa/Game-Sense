...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, partialTicks, x, y, z))
        {
            ...
            this.mainModel.isChild = GameSense.instance.featureManager.getFeature(BabyBoy.class).isEnabled() && entity == Minecraft.getMinecraft().player
                    ? true : entity.isChild();
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        boolean chamsCheck = GameSense.instance.featureManager.getFeature(Chams.class).isEnabled() && entitylivingbaseIn instanceof EntityPlayer;
