...
import Game.Sense.client.feature.impl.visual.NameTags;
...
public abstract class Render<T extends Entity> implements IEntityRenderer {
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
        if (GameSense.instance.featureManager.getFeature(NameTags.class).isEnabled() && !(AntiBot.isBotPlayer.contains(entityIn)) || GameSense.instance.featureManager.getFeature(NameTags.class).isEnabled()) {
            return;
        }
        ...
        if (d0 <= (maxDistance * maxDistance)) {
            ...
            if (GameSense.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.otherName.getBoolValue() && str.contains(entityIn.getName()) && !(entityIn instanceof EntityArmorStand))
                str = "Protected";
