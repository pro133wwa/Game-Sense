...
public class ModelPlayer extends ModelBiped {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        if ((!CustomModel.onlyMe.getBoolValue() || entityIn == (Minecraft.getMinecraft()).player || (GameSense.instance.friendManager.isFriend(entityIn.getName()) && CustomModel.friends.getBoolValue())) && !CustomModel.modelMode.currentMode.equals("None") && GameSense.instance.featureManager.getFeature(CustomModel.class).isEnabled()) {
            if (CustomModel.modelMode.currentMode.equals("Amogus")) {
                ...
                if (CustomModel.friendHighlight.getBoolValue() && GameSense.instance.friendManager.isFriend(entityIn.getName())) {
            ...
            } else if (GameSense.instance.featureManager.getFeature(CustomModel.class).isEnabled() && CustomModel.modelMode.currentMode.equals("Jeff Killer")) {
            ...
            } else if (GameSense.instance.featureManager.getFeature(CustomModel.class).isEnabled() && CustomModel.modelMode.currentMode.equals("Rabbit")) {
                GlStateManager.pushMatrix();
            ...
            } else if (GameSense.instance.featureManager.getFeature(CustomModel.class).isEnabled() && CustomModel.modelMode.currentMode.equals("Demon")) {
    ...
    public void renderCape(float scale) {
        if (!GameSense.instance.featureManager.getFeature(CustomModel.class).isEnabled() || (!CustomModel.modelMode.currentMode.equals("Werewolf") && !CustomModel.modelMode.currentMode.equals("Rabbit") && !CustomModel.modelMode.currentMode.equals("Sonic") && !CustomModel.modelMode.currentMode.equals("CupHead") && !CustomModel.modelMode.currentMode.equals("Chinchilla") && !CustomModel.modelMode.currentMode.equals("Freddy Bear") && !CustomModel.modelMode.currentMode.equals("Amogus") && !CustomModel.modelMode.currentMode.equals("Demon") && !CustomModel.modelMode.currentMode.equals("Red Panda") && !CustomModel.modelMode.currentMode.equals("Crab") && !CustomModel.modelMode.currentMode.equals("Jeff Killer") && !CustomModel.modelMode.currentMode.equals("GameSense")))
