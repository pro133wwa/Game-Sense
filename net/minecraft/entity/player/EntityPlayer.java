...
import Game.Sense.client.Helper.events.impl.player.EventUpdateLiving;
import Game.Sense.client.module.feature.MOVEMENT.KeepSprint;
import Game.Sense.client.module.feature.OTHER.NameProtect;
import Game.Sense.client.module.feature.MOVEMENT.Speed;
import Game.Sense.client.module.feature.MOVEMENT.Strafe;
...
import Game.Sense.client.mine.wavecapes.CapeHolder;
import Game.Sense.client.mine.wavecapes.stim.StickSimulation;
...
public abstract class EntityPlayer extends EntityLivingBase implements CapeHolder {
    ...
    public void onUpdate() {
        this.noClip = GameSense.instance.featureManager.getFeature(NoClip.class).isEnabled() || GameSense.instance.featureManager.getFeature(FreeCam.class).isEnabled() || this.isSpectator();
...
//            }
    ...
    public String getName() {
        ...
        if (this == (Minecraft.getMinecraft()).player && FakeNameCommand.canChange) {
            ...
            str = (GameSense.instance.featureManager.getFeature(NameProtect.class).isEnabled() && NameProtect.myName.getBoolValue() && this == (Minecraft.getMinecraft()).player) ? "Protected" : this.gameProfile.getName();
        }
        return str;
    }
    ...
    public boolean isPushedByWater() {
        if (GameSense.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.water.getBoolValue()) {
            return false;
        }
        return !this.capabilities.isFlying;
    }
