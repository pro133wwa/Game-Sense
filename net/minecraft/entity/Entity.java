...
public abstract class Entity implements ICommandSender {
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        if (GameSense.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getBoolValue()) {
            return false;
        } else {
    ...
    public float getCollisionBorderSize() {
        ...
        if (GameSense.instance.featureManager.getFeature(HitBox.class).isEnabled()) {
