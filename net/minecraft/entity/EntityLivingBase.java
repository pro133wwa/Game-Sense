...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        if (GameSense.instance.featureManager.getFeature(SwingAnimations.class).isEnabled()) {
    ...
    public boolean canBePushed() {
        if (GameSense.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.players.getBoolValue() && this instanceof EntityPlayerSP) {
            return false;
        }
